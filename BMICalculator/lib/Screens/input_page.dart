...
// If there is some value that it is possibly to be changed later in the development
// process, then feel free to create const vars at the top level of your code
// Refactoring Tips.
        ...
        children: [
          ...
          BottomButton('CALCULATE', () {
            ...
            Navigator.push(
                context,
                MaterialPageRoute(
                    builder: (_) => BMICalc(bmi.calcBMI(), bmi.getResult(),
