...
/// By Ahmed Hodhod @2021 ( Training on using Flutter)
...
/**
 * Inspire designs "dribble" website 
 
 *  to create your own theme for the project ( such as a default color for each 
    newly-created button), provide a theme parameter to the constructor of 
    MaterialApp.
   This helps to create your customized app with your own taste of 
    colors for all screens of the app. i.e, it is a dynamic way of setting colors
    and  making the desgin consistent. 
 ...
 *  Consider the structure of inputPage very carefully. 
    ...
    inside Expandeds, use Containers to get a customized decoration 
 ...
 * Navigation : use the link below for a full guide on Navigation
